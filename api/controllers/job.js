var JobService = require('../services/jobs')
...
exports.getJobs = async function(req, res, next){
    ...
    try{
        ...
        return res.status(200).json({status: 200, data: Jobs, message: "Succesfully Jobs Recieved"});
    }catch(e){
...
exports.createJob = async function(req, res, next){
    ...
    try{
        ...
        return res.status(201).json({status: 201, data: createdJob, message: "Succesfully Created ToDo"})
    }catch(e){
