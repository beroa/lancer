        ...
        if (this.isLoggedIn) {
            this.auth.profile().subscribe(function (res) {
                ...
                _this.blockexplorer.get_addr(_this.user.address).subscribe(function (res) {
                    _this.api_data_user_addr = res.data;
                });
            });
        }
    };
